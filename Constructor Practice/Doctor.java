...
public class Doctor {
	...
	public Doctor(int doctorId, String doctorName, int doctorAge, String doctorCity, String doctorGender,long doctorMobileNo, String specialization) {
	      this.doctorId = doctorId;
	        ...
	        this.specialization = specialization;}public void showDoctorDetails() {
